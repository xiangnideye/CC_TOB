<template>
  <div class="about" id="about">
    <v-nav-menu v-show="navHide"></v-nav-menu>
...
<style>
  ...
  .about-header-img{
    ...
    width: 100%;
    height: 240px;
    background: url("../../common/img/M_img/m-bg-us-1@2x.png")no-repeat center;
  ...
  .about-left-img{
    ...
    width: 315px;
    height: 153px;
    background: url('../../common/img/M_img/m-bg-us-2@2x.png') no-repeat;
  }
  .about-right-img{
    display: block;
    width: 315px;
